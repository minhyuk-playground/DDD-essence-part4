...
import org.eternity.phone.contract.rateplan.domain.RegularRateAndTaxableAndDiscountablePlan;
    ...
    ApplicationRunner runner(
        ...
        return (args) ->
                template.executeWithoutResult(
                        (status) -> {
                            RatePlan ratePlan = new RegularRateAndTaxableAndDiscountablePlan(
                                                    Money.won(5),
