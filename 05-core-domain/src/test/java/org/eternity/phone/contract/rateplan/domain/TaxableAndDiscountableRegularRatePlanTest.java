...
public class TaxableAndDiscountableRegularRatePlanTest {
    @Test
    public void 일반요금제_세금_기본요금할인_요금_계산() {
        ...
        RegularRatePlan plan = new RegularRateAndTaxableAndDiscountablePlan(
