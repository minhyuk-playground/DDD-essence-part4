...
public class CallRecordBillingRepositoryTest {
    @Autowired
    ...
    public void call_load() {
        ...
        callRecordBillingRepository.saveAllAndFlush(
                List.of(
        ...
        Collection<CallRecord[]> calls = callRecordBillingRepository.findCallRecordsToBill("010-1111-2222");
